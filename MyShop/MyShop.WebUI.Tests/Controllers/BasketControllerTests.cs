...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder() {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "parllaku80@gmail.com", ZipCode = "12345" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("parllaku80@gmail.com", "Forms"), null);
